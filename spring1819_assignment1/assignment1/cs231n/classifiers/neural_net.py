...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        dW2 = hidden_layer.T @ probabilities / N
        db2 = np.sum(probabilities, axis=0) / N

        dhidden_layer = probabilities @ W2.T

        dhidden_layer[hidden_layer <= 0] = 0

        dW1 = X.T @ dhidden_layer / N
        db1 = np.sum(dhidden_layer, axis=0) / N
